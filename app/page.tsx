      ...
      <main className="main-content">
        <div className="landing-container">
          ...
          <div className="tutorial-link">
            <Link href="/tutorial">How to look for canvas access token</Link>
          </div>

          <div className="marketing-content">
            <ul>
              <li>Never miss an assignment again!</li>
              <li>See all your assignments and announcements all in one place</li>
              <li>Free, Open Source</li>
              <li>Secure (interact using CanvasAPI), NO SERVER</li>
            </ul>
          </div>
        </div>
      </main>
